...
const Page2 = () => {
  ...
  return (
    <div id='section1' className="bg-white text-black">
    ...
    className="text-[30vw] text-center font-[shi] leading-[0.8] m-3">
        ...
        <div id='' className='text-[30vw] text-center font-[shi] leading-[25vw]'>
            <div className='section2'><h1>IMAPACTFUL </h1></div>
            <div className='section2'><h1>DESIGN</h1></div>
            <div className='section2'><h1>IS THE</h1></div>
            <div className='section2'><h1>DESIGN </h1></div>
            <div className='section2'><h1>THAT</h1></div>
            <div className='section2 relative'>
                {/* <canvas className='absolute h-full w-[65%] -translate-y-10 left-1/2 -translate-x-1/2 bg-slate-600'></canvas> */}
                <h1>WORKS!</h1></div>
    ...
    <g>
        ...
        <div className='h-0.5 w-1/3 relative left-1/2 -translate-x-1/2 bg-slate-900'></div>
